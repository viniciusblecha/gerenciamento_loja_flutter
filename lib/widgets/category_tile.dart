...
import 'package:gerenciamento_loja/screens/product_screen.dart';
        ...
        child: ExpansionTile(
          leading: GestureDetector(
            onTap: () {
              showDialog(
                context: context,
                builder: (context) => EditCategoryDialog(category: _category),
              );
            },
            child: CircleAvatar(
          ...
          title: Text(
            _category.data["title"],
            style:
                TextStyle(color: Colors.grey[850], fontWeight: FontWeight.w500),
          ),
          children: <Widget>[
            StreamBuilder<QuerySnapshot>(
              stream: _category.reference.collection("items").snapshots(),
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => ProductScreen(
                                categoryId: _category.documentID,
                                product: doc,
                              ),
                            ),
                          );
